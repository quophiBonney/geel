      ...
      <Row className="justify-content-center">
        ...
        <Col xs={12} sm={12} md={12} lg={6} xl={6} className="mt-5 mb-3 px-4">
          <p className="text-dark mt-5" id="ceo-text">
            ...
            Whether you need assistance with designing, installing, or
            maintaining electrical systems, we have the expertise and experience
            to deliver exceptional results. Thank you for your continued trust
            in our company. We look forward to working with you and helping you
            achieve your goals.
          </p>
        </Col>
      </Row>
